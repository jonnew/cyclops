...
Source** CyclopsLib::globalSourceList_ptr = globalSourceList;
Cyclops cyclops(CH0);
...
void setup()
{
  ...
  Timer1.attachInterrupt(CyclopsLib::cyclops_timer_isr); // Defined in Waveform_t.h
}
...
void loop()
{
  ...
  CyclopsLib::readSerialAndPush(&processQueue);
  digitalWrite(14, HIGH);
